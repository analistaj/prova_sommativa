...
<html lang="en">
<head>
<title>Broccolo Bill - la cucina Veg per la famiglia</title>
<meta charset="utf-8">
        ...
        <div class="banner">
          ...
          <div class="bann_capt ">
            <div class="maxheight">
              ...
              <div class="bann_title">Cucina tradizionale</div>
              <a href="#">leggi</a>
            </div>
          </div>
        </div>
        ...
        <div class="banner">
          ...
          <div class="bann_capt  bn__1">
            <div class="maxheight">
              ...
              <div class="bann_title">Broccolo Bimbi &amp; Menu Vegani</div>
              <a href="#">leggi</a>
            </div>
          </div>
        ...
        <div class="banner ">
          ...
          <div class="bann_capt  bn__2">
            <div class="maxheight">
              ...
              <div class="bann_title">Happy Hours <br> &amp; Offerte</div>
              <a href="#">leggi</a>
            </div>
          </div>
		  </div>
        ...
        <div class="box">
          <div class="row">
            <div class="grid_5 preffix_1">
              <h2>Le nuove frontiere del gusto</h2>
